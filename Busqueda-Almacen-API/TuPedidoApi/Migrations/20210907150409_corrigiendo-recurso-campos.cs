...
{
    public partial class corrigiendorecursocampos : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PozoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    NombrePozo = table.Column<string>(nullable: true),
                    Campana = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pozos", x => x.PozoId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConstruccionId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    PozoId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Construcciones", x => x.ConstruccionId);
                    table.ForeignKey(
                        name: "FK_Construcciones_Pozos_PozoId",
                        column: x => x.PozoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IntervaloId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ConstruccionId = table.Column<int>(nullable: false),
                    Camisa = table.Column<string>(nullable: true),
                    Longitud = table.Column<string>(nullable: true),
                    Barrena = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Intervalos", x => x.IntervaloId);
                    table.ForeignKey(
                        name: "FK_Intervalos_Construcciones_ConstruccionId",
                        column: x => x.ConstruccionId,
                        principalTable: "Construcciones",
                        principalColumn: "ConstruccionId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Intervalos_ConstruccionId",
                table: "Intervalos",
